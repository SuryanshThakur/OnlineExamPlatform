var pos = 0, test, test_status, questions,  choice, choices, chA, chB, chC, correct = 0; 
	var questions = [
		["The title element must be located inside?", "the head element", "the body element","None of these", "A" ],
		["Who created javascript?", "Brendan Eich", "Kimmy Matillano", "Saxon Ong", "A"],
		["What does HTML stand for?", "Home Tool Markup Language", "Hyper Text Markup Language", "Hyperlinks and Text Markup Language", "B"],
		["Who is making the Web standards?", "Google ", "The World Wide Web Consortium ", "Mozilla ", "B"],
